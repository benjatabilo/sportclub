...
function CoachLayout() {
  ...
  const navLinks = [
    { to: "/coach/dashboard", label: "Inicio Coach", icon: HomeIcon },
    { to: "/coach/coachclass", label: "Mis Clases", icon: DumbbellNavIcon },
    { to: "/coach/coachschedule", label: "Horarios", icon: CalendarNavIcon },
  ];
      ...
      <Row className="g-0">
        ...
        <Col xs={12} md={10} style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
          ...
          >
            ...
            {/* Círculo de perfil (Botón que abre el modal) */}
            <div
